...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: 'Practice with real questions and get instant feedback. Pro plan includes an AI that listens during live calls and feeds you answers in real time.',
  ...
  },
  {
    ...
    description: 'Message hiring managers directly — bypassing the black hole of job portals. Each message is personalized using the recruiter\'s own public profile.',
  ...
  },
  {
    ...
    subtitle: 'Get discovered first',
    description: 'Optimizes your LinkedIn, Indeed, and other portal profiles so recruiters find you at the top of search results for your skill set.',
    plan: 'Pro & Max plans',
    icon: <ISearch />,
  },
  {
    ...
    description: 'Sends 3,000 personalized emails per month to hiring managers directly from your Gmail — while you focus on interviewing.',
  ...
  },
  {
    ...
    description: 'Full simulated interview rounds — behavioral, technical, and case. Scored feedback on every answer so you know exactly what to improve.',
    plan: 'Pro & Max plans',
    icon: <IVideo />,
  },
  {
    ...
    subtitle: 'Beyond job boards',
    description: 'Applies directly to roles on company career pages — invisible on job boards. Access the hidden job market before anyone else sees it.',
    plan: 'Lite+ plans',
    icon: <IBuilding />,
  },
]
